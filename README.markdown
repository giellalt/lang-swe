...
This directory contains source files for the Swedish language morphology
...
-   <https://giellalt.uit.no/lang/swe/index.html> (analyser)
...
The Swedish language sources can be acquired using [giella SVN
