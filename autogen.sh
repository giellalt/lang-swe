...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_swe to login script."
...
# the current dir:
if   test x${GTLANG_swe} = x ; then
	echo "WARNING: The variable \${GTLANG_swe} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_swe} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_swe} has the value:"
	echo "  ${GTLANG_swe}"
